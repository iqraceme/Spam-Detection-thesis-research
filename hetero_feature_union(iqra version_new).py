    ...
    ('union', FeatureUnion(
        transformer_list=[
           ('message4', Pipeline([
                ...
                ('count', CountVectorizer(ngram_range=(1, 1), analyzer='char_wb')),
            ])),     
           ('message5', Pipeline([
                ('selector', ItemSelector(key='message')),
                ('count', CountVectorizer(ngram_range=(2, 2), analyzer='char_wb')),
            ])),      
                
           ('message3', Pipeline([
                ('selector', ItemSelector(key='message')),
                ('count', CountVectorizer(ngram_range=(3, 3), analyzer='word')),
            ])),
